...
return ( 
    <div class="container p-6 mx-auto flex flex-wrap border-b border-gray-500">
        {showBanner && (
            <>
        <div class="xl:w-2/3 w-full">
            <p class="font-heading text-lg font-medium mb-4">
        ...
        <div class="xl:w-1/3 w-full flex items-center font-medium xl:justify-end justify-start gap-5">
            <button 
                class="py-4 px-8 font-heading font-medium text-base text-white border rounded-sm transition duration-200 bg-red-500 border-red-500 hover:border-red-600 hover:bg-red-600"
                type="button"
                onClick={acceptCookies}
                >Accept
            </button>
            <button
                class="py-4 px-8 font-heading font-medium text-base border rounded-sm border-red-500 hover:border-red-600 hover:bg-red-100 duration-200"
                type="button"
