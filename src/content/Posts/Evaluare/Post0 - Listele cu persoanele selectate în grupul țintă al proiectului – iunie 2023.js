...
export const options = {
	"title": "Listele cu persoanele selectate în grupul țintă al proiectului – iunie 2023",
	"category": "EVALUARE",
...
export default function Post(){
	...
	<div class="accordion-content mt-4">
                  ...
                  <a href="https://www.marinex-constructii.ro/proiect/154155/wp-content/uploads/sites/2/2023/07/A4_iun.23_Lista-dosare-selectate-publicata.pdf" class="items-center text-lg underline hover:text-red-500">A4_iun.23_Lista-dosare-selectate-publicata</a>
                  </div>
	</>
	)
}
